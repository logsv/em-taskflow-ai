...
| **`ollama-slm-ops`** | [`.agents/skills/ollama-slm-ops/SKILL.md`](file://.agents/skills/ollama-slm-ops/SKILL.md) | Procedures for managing local Ollama SLM inference (`hermes3:8b`, `mistral`, `nomic-embed-text`), model parameters, and Open WebUI integration. |
