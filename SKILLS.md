...
| :--- | :--- | :--- |
| **`admin-portal-ops`** | [`.agents/skills/admin-portal-ops/SKILL.md`](file://.agents/skills/admin-portal-ops/SKILL.md) | Operations for managing the Standalone Admin Portal (`/admin`), external service hubs (Langfuse, Open WebUI, Adminer, Dozzle), vector chunk inspection, and Express administrative APIs. |
...
| **`langgraph-slm-agent`** | [`.agents/skills/langgraph-slm-agent/SKILL.md`](file://.agents/skills/langgraph-slm-agent/SKILL.md) | Procedures for managing LangGraph supervisor routing, 10 domain micro-agent tool bounding, and local Ollama SLM execution. |
| **`ollama-slm-ops`** | [`.agents/skills/ollama-slm-ops/SKILL.md`](file://.agents/skills/ollama-slm-ops/SKILL.md) | Procedures for managing local Ollama SLM inference (`llama3.2`, `mistral`, `nomic-embed-text`), model parameters, and Open WebUI integration. |
