...
import * as chromaService from '../src/services/chromaService.js';
...
describe('RAG Service', () => {
  ...
  let chromaCreateCollectionStub: sinon.SinonStub;
  let chromaAddDocumentsStub: sinon.SinonStub;
  let chromaQueryCollectionStub: sinon.SinonStub;
  let chromaListCollectionsStub: sinon.SinonStub;
  ...
  describe('generateEmbedding', () => {
    it('should generate an embedding successfully', async () => {
      ...
      const embedding = await (ragService as any).generateEmbedding(text);
    ...
    it('should throw an error if embedding generation fails', async () => {
      ...
      await expectAsync((ragService as any).generateEmbedding('test')).toBeRejectedWithError('Failed to generate embedding');
    });
  });
