...
describe('Summary Formatter', () => {
  describe('formatDataForLLM', () => {
    ...
    it('should format calendar conflicts correctly', async () => {
      ...
      const data = {
        calendarConflicts: [[event1, event2]],
      };
    ...
    it('should format all data types together', async () => {
      const data = {
        jiraTasks: [{ key: 'TASK-1', summary: 'Test task', status: 'Done' }],
        notionPages: [{ title: 'Test Page', last_edited_time: '2023-01-01' }],
        calendarEvents: [{ summary: 'Test Event', start: '10:00', end: '11:00' }],
        calendarConflicts: [[
    ...
    it('should handle tasks without keys', async () => {
      const data = {
        jiraTasks: [{ summary: 'Task without key', status: 'In Progress' }],
      };
