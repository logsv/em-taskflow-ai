 ...
 */
export async function initializeLLMRouter() {
 ...
 */
export async function routedChatCompletion(messages, options = {}) {
 ...
 */
export async function testRouter(prompt = 'Hello, world!') {
  try {
    await ensureRouterReady();
