...
export class JiraOAuthProvider {
  get oauthConfig() {
    ...
    return {
      ...
      redirectUrl: cached.redirectUrl || process.env.JIRA_OAUTH_REDIRECT_URL || mcpConfig.redirectUrl || 'http://localhost:4000/api/mcp/jira/oauth/callback',
      scope: cached.scope || mcpConfig.scope || 'read:jira-work read:jira-user offline_access',
    };
  }

  get redirectUrl() {
    return this.oauthConfig.redirectUrl || 'http://localhost:4000/api/mcp/jira/oauth/callback';
  }
