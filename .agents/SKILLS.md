...
| **`langgraph-slm-agent`** | [`skills/langgraph-slm-agent/SKILL.md`](file://.agents/skills/langgraph-slm-agent/SKILL.md) | Procedures for managing LangGraph supervisor routing, 1-tool bounding policy, and local Ollama SLM execution. |
| **`ollama-slm-ops`** | [`skills/ollama-slm-ops/SKILL.md`](file://.agents/skills/ollama-slm-ops/SKILL.md) | Procedures for managing local Ollama SLM inference (`llama3.2`, `mistral`, `nomic-embed-text`), model parameters, and Open WebUI integration. |
